...
public class FriendsViewModel extends ViewModel {
    ...
    static private MutableLiveData<List<User>> friends;
    ...
    static {
        ...
        friends = new MutableLiveData<List<User>>();
    }
    ...
    static public MutableLiveData<List<User>> getFriends(final RecyclerView recycler, final Context context) {
